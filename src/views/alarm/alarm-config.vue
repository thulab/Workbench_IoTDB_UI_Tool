    ...
    <el-header class="search-form-wrapper p-0" style="height: auto">
      <el-form :model="searchFormData" ref="searchFormRef" label-position="left" size="default" inline>
        ...
        <base-form-item prop="alarmLevel">
          ...
          <el-select v-model="searchFormData.alarmLevel" :style="{ color: getLevelColor() }" class="level-select-box" style="width: 90px" id="alarm-config-search-level">
            <template #prefix>
      ...
      <div class="search-form-buttons">
        <el-button @click="handleReset" id="alarm-config-search-reset">{{ t('common.reset') }}</el-button>
