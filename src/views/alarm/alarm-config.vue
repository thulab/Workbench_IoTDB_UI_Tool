    ...
    <el-header class="search-form-wrapper p-0" style="height: auto">
      <el-form :model="searchFormData" ref="searchFormRef" label-position="left" size="default" inline>
        ...
        <base-form-item prop="alarmLevel">
          ...
          <el-select v-model="searchFormData.alarmLevel" :style="{ color: getLevelColor(), width: locale === 'en' ? '100px' : '90px' }" class="level-select-box" id="alarm-config-search-level">
            <template #prefix>
...
const searchFormData = reactive({
  ...
  updatetimerange: null as unknown as [number, number] | [string, string] | [Date, Date],
  alarmLevel: '',
  status: '',
