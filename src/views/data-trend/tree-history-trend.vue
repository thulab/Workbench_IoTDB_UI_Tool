<template>
  <div class="relative w-full h-full flex">
    <div class="w-256px bg-white flex-shrink-0 rounded-6px">
      <SideTree ref="measurementSideTree" :can-read-write-schema="canReadWriteSchema" :current-node="currentNode" @handle-change-node="handleChangeNode" @doubleClickMeasurement="createGroup" />
    </div>
