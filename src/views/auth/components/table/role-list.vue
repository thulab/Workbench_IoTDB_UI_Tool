...
const { requestFn: getRoleList, loading } = useRequest(RelationalPrivilegesApi.getRoles, {
  initData: [],
});
const { requestFn: deleteRole } = useRequest(RelationalPrivilegesApi.deleteRole);
