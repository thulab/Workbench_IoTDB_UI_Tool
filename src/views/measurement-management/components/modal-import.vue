<template>
  ...
  >
    ...
    <div class="m-t-12" style="text-align: right;" v-if="activeStep === 0">
      <el-button plain :disabled="!uploadFileInfo" @click="handleNext" id="measurement-import-next">下一步</el-button>
    </div>

    <div class="m-t-12" style="height: 28px;" v-if="activeStep === 1"></div>

    <div class="m-t-12" style="text-align: center;" v-if="activeStep === 2">
      <el-button type="primary" @click="handleClose" id="measurement-import-close">完成</el-button>
    </div>
  </el-dialog>
</template>
