...
export const functionTreeData = [
  {
    ...
    children: [
      { label: '统计时间序列的个数', value: 'COUNT' },
      { label: '时间序列数据的平均值', value: 'AVG' },
      { label: '时间序列数据的和', value: 'SUM' },
  ...
  },
  {
    ...
    children: [
      { label: '返回某时间序列中值最大的k个数据点', value: 'TOP_K' },
      { label: '返回某时间序列中值最小的k个数据点', value: 'BOTTOM_K' },
    ],
  },
  {
    label: '趋势计算函数',
    value: 'sqlSearch.sum',
    children: [
      { label: '统计序列中某数据点的时间戳与前一数据点时间戳的差', value: 'TIME_DIFFERENCE' },
      { label: '统计序列中某数据点的值与前一数据点的值的差', value: 'DIFFERENCE' },
      { label: '统计序列中某数据点的值与前一数据点的值的差的绝对值', value: 'NON_NEGATIVE_DIFFERENCE' },
      { label: '统计序列中某数据点相对于前一数据点的变化率', value: 'DERIVATIVE' },
      { label: '统计序列中某数据点相对于前一数据点的变化率的绝对值', value: 'NON_NEGATIVE_DERIVATIVE' },
    ],
  },
  {
    label: '时间函数',
