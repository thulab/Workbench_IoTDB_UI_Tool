...
class UserApi {
  ...
  // 当前登录用户权限
  static getLoginUserPrivileges(): HttpResponseP<Auth.UserPrivileges & { connection: Connection.ConnectionDetail, isMaster: boolean, slaveIsConnection: boolean } & { version: string }> {
