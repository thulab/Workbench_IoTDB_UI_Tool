...
import type { CascaderConfig, CascaderNodePathValue, CascaderNodeValue, CascaderOption } from 'element-plus/es/components/cascader-panel/src/node';
...
export default class Store {
  ...
  getNodeByValue(value: CascaderNodeValue | CascaderNodePathValue, leafOnly = false): Nullable<Node> {
    ...
    const node = this.getFlattedNodes(leafOnly).find((nodeItem) => isEqual(nodeItem.value, value) || isEqual(nodeItem.pathValues, value));
